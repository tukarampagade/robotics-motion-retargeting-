...
export const GestureGuide: React.FC<GestureGuideProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-white/95 backdrop-blur-md rounded-2xl border border-slate-200 shadow-xl overflow-hidden text-slate-800">
        {/* Header Bar */}
        <div className="px-3 py-2 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 rounded-md bg-sky-50 border border-sky-200 flex items-center justify-center text-sky-600">
        ...
        {!isMinimized && (
          <div className="p-2 space-y-1.5 max-h-72 overflow-y-auto font-mono text-[10px]">
              ...
              return (
                <div
                  ...
                  className={`px-2.5 py-1.5 rounded-xl border transition-all flex items-center justify-between ${
                    isActive
                      ? 'bg-sky-50/90 border-sky-400 shadow-2xs scale-[1.01]'
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="leading-tight">
                      <div className="flex items-center gap-1.5">
                        ...
                        {isActive && (
                          <span className="px-1.5 py-0.2 rounded-full bg-sky-600 text-white text-[8px] font-semibold animate-pulse">
                            ACTIVE
                          </span>
                        )}
                      </div>
            ...
            <div className="pt-1.5 border-t border-slate-100 text-[9px] text-slate-500 text-center flex items-center justify-center gap-1 font-mono">
